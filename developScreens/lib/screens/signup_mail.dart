...
//mobile
  ...
  bool isDoneButtonVisible = false;
        ...
        builder: (context, authProvider, _) {
          return CommonUI(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  EdgeInsets.symmetric(
                      vertical: 0, horizontal: 12 * scaleFactor),
                  label: RichText(
                    text: const TextSpan(
                      text: "Name",
              ...
              const ResponsiveSizedBox(height: 14),
              Form(
                key: _emailFormKey,
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: const Icon(
                        Icons.email, color: Color(0xEDE51D23)),
                  ),
                  autofocus: false,
                  validator: (value) {
                    if (value!.isEmpty) {
              ...
              ResponsiveContainer(
                child: ElevatedButton(
                  onPressed: isChecked
                      ? () => _submitForm(context, authProvider)
                      : null,
  ...
  void _submitForm(BuildContext context, AuthProvider authProvider) {
